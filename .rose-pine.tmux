...
#
# Slightly Modified by winterbitia
#
...
main() {
    ...
    # Status bar
    set "status" "on"
    set status-style "fg=$thm_muted,bg=$thm_base"
    ...
    setw window-status-current-style "fg=${thm_rose},bg=${thm_base}"
    ...
    local show_session
    # readonly show_session=" #[fg=#{?client_prefix,$thm_love,$thm_text}]$current_session_icon #[fg=$thm_text]#S#[fg=$thm_subtle]$left_separator"
    readonly show_session=" #[fg=#{?client_prefix,$thm_love,$thm_text}]$current_session_icon#[fg=$thm_subtle]$left_separator"

    local show_user
    readonly show_user="#[fg=$thm_subtle]$username_icon$spacer#[fg=$thm_iris]#(whoami)#[fg=$thm_subtle]$right_separator"

    local show_host
    readonly show_host="#[fg=$thm_subtle]$hostname_icon$spacer#[fg=$thm_text]#H#[fg=$thm_subtle]$right_separator"

    local show_date_time
    readonly show_date_time="#[fg=$thm_subtle]$date_time_icon$spacer#[fg=$thm_foam]$date_time#[fg=$thm_subtle]$right_separator"
